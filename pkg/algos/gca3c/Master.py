...
class Stats(Process):
    ...
    def run(self):
        ...
        with open('results/gca3c_result.txt', 'w') as f:
            while True:
...
class Master(object):
    ...
    def __init__(self):
        ...
        self.exp_cache = []
        self.max_exp_cache_size = 10000 

    def put_sample(self, x, r, a):
        while len(self.exp_cache) >= self.max_exp_cache_size:
            self.exp_cache.pop(0)
        self.exp_cache.append((x, r, a))
