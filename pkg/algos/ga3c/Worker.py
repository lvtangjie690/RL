...
class Worker(Process):
    def __init__(self, id, master, lock):
    ...
    def predict_p_and_v(self, state):
        self.master.prediction_queue.put((self.id, state))
        prediction, value = self.result_queue.get()
    ...
    def run(self):
        ...
        with self.lock:
            self.master.state_space_size.value = state_space_size
            self.master.action_space_size.value = action_space_size
