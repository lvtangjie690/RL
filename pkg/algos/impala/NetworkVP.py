...
class NetworkVP(object):
    ...
    def _create_graph(self):
        ...
        self.cost_v = 0.5 * tf.reduce_sum(tf.square(self.v - self.logits_v), axis=0)
        ...
        self.cost_p_1 = self.rho * tf.log(self.selected_action_prob) \
    ...
    def train(self, x, a, y_r, v, rho, trainer_id):
        feed_dict = self.__get_base_feed_dict()
        feed_dict.update({self.x: x, self.y_r: y_r, self.action_index: a, self.v:v, self.rho:rho})
